/**
 * CrowdSense AI - Static Data Module
 * Contains all dummy/static JSON data for the dashboard prototype.
 * No backend required — all data is served from this file.
 */
...
const CrowdSenseData = (() => {
    ...
    /* ───────────────────────── Chart Data ───────────────────────── */
    const historicalCrowdTrend = {
        labels: ['6 AM', '8 AM', '10 AM', '12 PM', '2 PM', '4 PM', '6 PM', '8 PM', '10 PM'],
        datasets: [
            {
                label: 'Today',
                data: [400, 1200, 1800, 2200, 2450, 2900, 3400, 2800, 1600],
                borderColor: '#2563EB',
            ...
            {
                label: 'Yesterday',
                data: [350, 1100, 1650, 2000, 2300, 2700, 3100, 2500, 1400],
                borderColor: '#6B7280',
    ...
    const crowdPrediction = {
        ...
        datasets: [{
            ...
            data: [2450, 2600, 2780, 2900, 3000, 3080, 3120],
            borderColor: '#2563EB',
            backgroundColor: (ctx) => {
                if (!ctx.chart) return 'rgba(37,99,235,0.1)';
    ...
    const weatherImpact = {
        ...
        datasets: [
            {
                label: 'Crowd Density',
                data: [2100, 2400, 1800, 2600, 3200, 3800, 3500],
    ...
    const events = [
        {
            ...
            icon: 'fa-pray',
            description: 'Annual Ganesh Chaturthi immersion procession through major city routes'
        },
        {
            ...
            icon: 'fa-running',
            description: 'City-wide marathon spanning from CST to Worli Sea Link'
        },
        {
            name: 'College Cultural Festival',
            expectedVisitors: 7000,
            date: 'Aug 12, 2026',
            status: 'Upcoming',
            statusColor: 'var(--primary)',
            icon: 'fa-graduation-cap',
            description: 'Inter-college fest at Bandra Kurla Complex with live performances'
        }
    ];
